...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        mazmorra.addItem("Tienes que encontrar una cadena con bola",15F);
        torre.addItem("Coje el pergamino que esta escondido", 0.02F);
        //comedor.addItem("Recoge el candelabro que es más alto",2.5F);
        cocina.addItem("Necesitas la cuchara con la inscripción del León",0.50F);
